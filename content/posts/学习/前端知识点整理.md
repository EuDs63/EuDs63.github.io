...
- 参考
  ...
  - [css、js和图片文件加载会阻塞页面解析和渲染吗？同时加载10个js文件需要多长时间？从输入url到页面展示到底发生了什 - 掘金](https://juejin.cn/post/7011377094156353567 )
...
- async
  - async 特性意味着脚本是完全独立的：
    ...
    2. 加载完立即执行：其他脚本不会等待 async 脚本加载完成，同样，async 脚本也不会等待其他脚本。
...
## 测试
- 参考 [陈恩培 on X](https://x.com/chenenpei/status/1848673102215188690 )
