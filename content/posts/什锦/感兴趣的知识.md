...
- [x] [无风险年化 360%？小白也能懂的 Crypto 套利 - TARESKY](https://taresky.com/crypto-arbitrage)
...
- [x] [加盐密码哈希：如何正确使用-阿里云开发者社区](https://developer.aliyun.com/article/1043064 )
...
- [ ] [为什么说 GPT 是无损压缩 | K.I.S.S](https://bigeagle.me/2023/03/llm-is-compression/ )
- [ ] [握着你的手训一个类GPT语言模型 (一) | K.I.S.S](https://bigeagle.me/2023/03/pico-gpt-1/ )
...
- [ ] [基于 HMM 隐马尔可夫模型的智能拼音输入法 (带 Web 前端) | OrangeX4's Blog](https://blog.orangex4.workers.dev/post/simple-pinyin/ )
...
- [ ] [高效参与开源的诀窍 | 夜天之书](https://www.tisonkun.org/2021/12/05/effective-open-source-participant/ )
...
- [ ] [70场面试，复盘我遇到的有趣问题（一）_牛客网](https://www.nowcoder.com/feed/main/detail/a79cb52ce00c4f6d874683e65b8eb718?sourceSSR=users )
...
## 代理 
- [ ] [使用Frp内网穿透实现远程桌面(家里电脑远程控制公司电脑) - Newcats - 博客园](https://www.cnblogs.com/newcats/p/16124158.html )
- [ ] [Tailscale · Best VPN Service for Secure Networks](https://tailscale.com/ )
- [ ] [Tailscale · Best VPN Service for Secure Networks](https://tailscale.com/ )
- [ ] [搭建私人代理服务简易教程 | Norwegian Wood](https://akynazh.site/posts/2024/02/a-simple-tutorial-on-building-private-proxy-services/ )
