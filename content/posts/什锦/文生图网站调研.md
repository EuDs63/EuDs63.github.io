...
## 网站六 
[Image AI - All-in-One AI Image Platform](https://imgai.ai/ )

- **介绍**
  - 国人独立开发的出海网站，注册的美国公司
  - 骑龙 (@qilong87) / X
  - 前端： nextjs+shadcn/ui+tailwindcss ; 后端:   go； 收款：stripe；
  - 数据统计平台：Plausible Analytics | Simple, privacy-friendly Google Analytics alternative
  - 多语言： [lokalise/i18n-ally: 🌍 All in one i18n extension for VS Code](https://github.com/lokalise/i18n-ally )
  - 开发时长： 近两个月 [7月26日的一条推](https://x.com/qilong87/status/1816809575666049131)
    > 磕磕绊绊，http://imgai.ai 经过将近两个月开发，上周上线了，昨天提交了几个AI导航站，在 HN 发了个帖子，没想到今天被 TAAFT收录了，带来了一些流量，这个网站算是第一个走了一个完整的闭环，对我来说具有里程碑式的意义了
- **亮点**
  - 围绕image ai相关的功能很全，但尚不清楚是调api还是自己部署
  - 多语言支持 
  - [Image AI - Text-to-Image](https://imgai.ai/text-to-image )，prompt支持llm生成和润色
- **访问量与付费量**
  - 7月28日上线以来，到8月14日，一共两笔付费，共9.98，15日又两笔，也是9.98
  - [8月15日的一条推](https://x.com/qilong87/status/1823909521724727792)
- **价格**
  - 2Credits生成一张图，19.99美元送550 credits
...
- 价格
  - Scenario Pricing
  - $15/mo: 1,500 Creative Units
  - $45/mo: 5000 Creative Units

## 网站八
[ModelsLab](https://modelslab.com/ )

- 介绍
- AI api提供商，[ENHANCE AI ART: Create Amazing Images & Edit Photo | AI Image Enhance](https://enhanceai.art/ )似乎也是用的他家的api
- 价格
  - [Pricing - Stable Diffusion And Dreambooth API - Generate and Finetune Dreambooth Stable Diffusion using API](https://modelslab.com/pricing )
